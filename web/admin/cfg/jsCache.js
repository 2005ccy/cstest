...
(function(w, d, string, object, func, text, css, script, style, javascript,
    ...
    function Dictionary() {
         ...
         */
        dict[application + "/" + javascript] = dict[text + "/" + javascript] = dict[application + "/x-" + javascript] = dict["." + js] = dict[js] = dict[javascript] = dict[script] = js;

        /**
         * Accepted css synonyms
         */
        dict[text + "/" + css] = dict[css] = dict["." + css] = dict[stylesheet] = dict[style] = css;

        /**
         * Accepted pictures
         */
        dict[png] = dict["." + png] = dict[image + "/" + png] = dict[jpg] = dict["." + jpg] = dict[image + "/" + jpg] = dict[image + "/" + gif] = dict[gif] = dict["." + gif] = dict[image + "/" + svg] = dict["." + svg] = dict[svg] = img;
    ...
    var head = d.getElementsByTagName("head")[0].lastChild,
        ...
        jsCache = function() {
                    ...
                    if (obj.url && typeof obj.url === string && w.localStorage) {
                        ...
                        try {
                            ...
                            /* localStorage polyfill are throwing exception names that
                               ...
                               storage is full */
                            if ((exc.name && exc.name.match(/quota/i)) || exc.name === "Error") {
            ...
            if (!w.JSON) {
                tmp = "//cdn.bootcss.com/json2/20130526/json2.min.js";
                loading.push(tmp);
                loadScript({
                    url: tmp
                }, onload);
            ...
            if (!w.localStorage) {
                ...
                if (!w.swfobject) {
                    tmp = "//cdn.bootcss.com/swfobject/2.2/swfobject.js";
                    loading.push(tmp);
                    loadScript({
                        url: tmp
                    }, onload);
                ...
                tmp = "//cdn.bootcss.com/localStorage/2.0.1/localStorage.min.js";
                loading.push(tmp);
                loadScript({
                    url: tmp
                }, onload);
            ...
            return {
                ...
                load: function() {
                    var i,
                        ...
                        obj,
                        elm,
                        cors = new cross.cors(this.timeout),
                        dataChange,
                    ...
                    if (arguments.length > 0 && w.localStorage) {
                        ...
                        for (i = arguments.length - 1; i > -1; i -= 1) {
                            ...
                            if (source && typeof source === object && source.url &&
                                ...
                                dataChange = source.dataChange;
                                delete source.dataChange;
                                    ...
                                    try {
                                        ...
                                        cors.request(
                                            ...
                                            (function(obj, data, type) {
                                                ...
                                                if (this.dataChange) {
                                                    for (var dci in this.dataChange) {
                                                        var dco = this.dataChange[dci];
                                                        data = data.replace(dco.query, dco.replace);
                                                    }
                                                }
